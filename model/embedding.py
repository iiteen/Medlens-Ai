...
def context(user_query, chroma_db, k=5):
    if chroma_db is None:
        return [
            Document(page_content="This query do not need any extra context, So answer on your own understanding of the question.")
        ]
    relevant_results = chroma_db.similarity_search(query=user_query, k=min(k,number_of_chunks))
